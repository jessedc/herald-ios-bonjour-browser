                ...
                group.addTask {
                    do {
                        ...
                        return MatterDevice(
                            name: name,
                            serviceType: type,
                            discriminator: txt["D"]?.asString,
                            vendorProductID: txt["VP"]?.asString,
                            commissioningMode: txt["CM"]?.asString,
                            deviceType: txt["DT"]?.asString,
                            deviceName: txt["DN"]?.asString,
                            sessionIdleInterval: txt["SII"]?.asString,
                            sessionActiveInterval: txt["SAI"]?.asString,
                            tcpSupported: txt["T"]?.asString,
                            isICD: txt["ICD"]?.asString,
                            pairingHint: txt["PH"]?.asString,
